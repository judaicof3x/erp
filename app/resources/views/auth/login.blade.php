				...
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-image: url('{{ URL::asset('media/backgrounds/others.jpg') }}'); background-repeat: no-repeat; background-size: cover;">
					...
					<div class="d-flex flex-column position-xl-fixed w-xl-600px">
						...
						<div class="d-flex flex-column text-center p-10 pt-lg-20">
							...
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fs-4 text-white">Agência F3X,
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
								...
								<div class="text-center mb-10">
									...
									<!--end::Title-->
									<!--begin::Link-->
									<div class="text-gray-400 fw-bold fs-4">New Here? </div>
									<!--end::Link-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group-->
								...
								<div class="fv-row mb-10">
									...
									<div class="d-flex flex-stack mb-2">
										...
										<!--end::Label-->
										<!--begin::Link-->
										<a href="{{ route('password.update') }}" class="link-primary fs-6 fw-bolder">Esqueceu sua senha ?</a>
										<!--end::Link-->
									</div>
									<!--end::Wrapper-->
									<!--begin::Input-->
								...
								<button type="submit" class="btn btn-success col-12">Acessar</button>
							</form>
							<!--end::Form-->
						</div>
						<!--end::Wrapper-->
