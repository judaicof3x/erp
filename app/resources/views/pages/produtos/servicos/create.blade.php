            ...
            <div class="card-body pt-0">
                ...
                <div class="row mt-5">
                    <div class="col-lg-6">
                        ...
                        <input value="{{ old('amount') }}" data-inputmask="'mask': '999.999,99', 'numericInput': 'numericInput'" type="text" name="amount" class="form-control form-control-solid" placeholder="Insira o valor do serviço"/>
                    </div>
                    <div class="col-lg-6 mt-5 mt-lg-0">
                        <label for="amount_min" class="form-label">Valor mínimo do serviço</label>
                        <input value="{{ old('amount_min') }}" data-inputmask="'mask': '999.999,99', 'numericInput': 'numericInput'" type="text" name="amount_min" class="form-control form-control-solid" placeholder="Insira o valor mínimo do serviço"/>
                    </div>
                </div>
