                    ...
                    <div class="d-flex flex-center flex-column mb-5">
                        ...
                        <div class="d-flex flex-wrap flex-center">
                            ...
                            <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                ...
                                <div class="fw-bold text-muted">Serviços</div>
                            </div>
                            <!--end::Stats-->
                        </div>
                        <!--end::Info-->
                    ...
                    <div class="card pt-4 mb-6 mb-xl-9">
                        ...
                        <div class="card-header border-0">
                            ...
                            <div class="card-title">
                                <h2 class="fw-bolder mb-0">Serviços</h2>
                            </div>
                            <!--end::Card title-->
                            <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                <a href="#" class="btn btn-sm btn-flex btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card">
                                    ...
                                    <!--end::Svg Icon-->Vincular novo serviço</a>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                        <!--end::Card header-->
                            ...
                            <div class="py-0" data-kt-customer-payment-method="row">
                                ...
                                <div class="py-3 d-flex flex-stack flex-wrap">
                                    ...
                                    <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_1" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_1">
                                        ...
                                        <div class="me-3">
                                            <div class="d-flex align-items-center">
                                                <div class="text-gray-800 fw-bolder">Criação de e-commerce</div>
                                            </div>
                                            <div class="text-muted">Criação de marketplaces</div>
                                        </div>
                                        <!--end::Summary-->
                                    </div>
                                    <!--end::Toggle-->
                                    ...
                                    <div class="d-flex my-3 ms-9">
                                        ...
                                        <!--end::Edit-->
                                        <!--begin::Delete-->
                                        <a href="#" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="tooltip" title="" data-kt-customer-payment-method="deletar" data-bs-original-title="Deletar">
                                    ...
                                    <div class="d-flex flex-wrap py-5">
                                        ...
                                        <div class="flex-equal me-5">
                                            <table class="table table-flush fw-bold gy-1">
                                                <tbody><tr>
                                                    <td class="text-muted min-w-125px w-125px">Nome</td>
                                                    <td class="text-gray-800">Criação de e-commerce</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted min-w-125px w-125px">Valor</td>
                                                    <td class="text-gray-800">R$ 4.000,00</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="py-0" data-kt-customer-payment-method="row">
                                ...
                                <div class="py-3 d-flex flex-stack flex-wrap">
                                    ...
                                    <div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_2" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_2">
                                        ...
                                        <div class="me-3">
                                            <div class="d-flex align-items-center">
                                                <div class="text-gray-800 fw-bolder">Criação de arte</div>
                                            </div>
                                            <div class="text-muted">Criação de arte para rede social</div>
                                        </div>
                                        <!--end::Summary-->
                                    </div>
                                    <!--end::Toggle-->
                                    ...
                                    <div class="d-flex my-3 ms-9">
                                        ...
                                        <!--end::Edit-->
                                        <!--begin::Delete-->
                                        <a href="#" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="tooltip" title="" data-kt-customer-payment-method="delete" data-bs-original-title="Deletar">
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen027.svg-->
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M5 9C5 8.44772 5.44772 8 6 8H18C18.5523 8 19 8.44772 19 9V18C19 19.6569 17.6569 21 16 21H8C6.34315 21 5 19.6569 5 18V9Z" fill="black"></path>
                                    ...
                                    <div class="d-flex flex-wrap py-5">
                                        ...
                                        <div class="flex-equal me-5">
                                            <table class="table table-flush fw-bold gy-1">
                                                <tbody><tr>
                                                    <td class="text-muted min-w-125px w-125px">Nome</td>
                                                    <td class="text-gray-800">Criação de arte</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted min-w-125px w-125px">Valor</td>
                                                    <td class="text-gray-800">R$ 50,00</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
