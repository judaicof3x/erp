        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    <!--begin::Add customer-->
                    <a href="{{ route('painel.clientes.create') }}" class="btn btn-primary">Adicionar cliente</a>
                    <!--end::Add customer-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5">
                            ...
                            <tr class="odd">
                                ...
                                <td class="text-center">
                                    <a class="text-gray-600 mb-1">Ooops, ainda não temos nenhum cliente para exibir! =/</a>
                                </td>
                                <!--end::Name=-->
                            </tr>
                            </tbody>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table">
                            ...
                            @foreach($clients as $client)
                                <tr class="odd">
                                    ...
                                    <!--begin::Name=-->
                                    <td class="text-center">
                                        <a href="{{ route('painel.clientes.show', $client->id) }}" class="text-gray-600 text-hover-primary mb-1">
                                    ...
                                    <!--begin::Email=-->
                                    <td class="text-center">
                                        <a class="text-gray-600 text-hover-primary mb-1">{{ $client->segment }}</a>
                                    </td>
                                    <!--end::Email=-->
                                    <!--begin::Company=-->
                                    <td class="text-center">
                                        @if($client->is_active == 1)
                                            <span class="text-success mb-1"> Ativo </span>
                                        @else
                                            <span class="text-danger mb-1"> Inativo </span>
                                        @endif
                                    </td>
                                    <!--end::Company=-->
                                    <!--begin::Date=-->
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('painel.clientes.show', $client->id) }}" class="menu-link px-3">Visualizar</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
