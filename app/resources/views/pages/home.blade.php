        ...
        <div class="col-xl-4">
            ...
            <a href="#" class="card bg-body-white hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">Solta o Freio</div>
                    <div class="fw-bold text-gray-400">Camisas, dias de folga e mais</div>
                </div>
                <!--end::Body-->
            </a>
        ...
        <div class="col-xl-4">
            ...
            <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-white fw-bolder fs-2 mb-2 mt-5">Departamentos</div>
                    <div class="fw-bold text-white">Comercial, Financeiro, Produtos</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
        ...
        <div class="col-xl-4">
            ...
            <a href="#" class="card bg-dark hoverable card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">Relatório de vendas</div>
                    <div class="fw-bold text-gray-100">50% de crescimento na última semana</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Últimas vendas</span>
                        <span class="text-muted fw-bold fs-7">Subiu 15 vendas em relação ao último mês</span>
                    </h3>
                    <!--end::Title-->
                    <!--begin::Toolbar-->
                    <div class="card-toolbar">
                        ...
                        <!--begin::Menu 1-->
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61a094ad1278d">
                            <!--begin::Header-->
                            <div class="px-7 py-5">
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="mb-10">
                                    ...
                                    <!--begin::Input-->
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61a094ad1278d" data-allow-clear="true">
                                            <option></option>
