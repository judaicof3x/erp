<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="header-brand">
        <!--begin::Logo-->
        <a href="#">
            <img alt="Logo" src="{{ URL::asset('media/logos/F3X-Horizontal-Light.png') }}" class="h-75px h-lg-75px" />
        </a>
        <!--end::Logo-->
    ...
    <div class="toolbar d-none d-lg-flex">
        ...
        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            ...
            <div class="page-title d-flex flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Painel Administrativo</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="#" class="text-muted text-hover-primary">Ecosistema F3X</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                ...
                <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                    ...
                    <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        ...
                        <div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4">
                            <span class="text-muted fs-8 fw-bold lh-1 mb-1">{{ Auth::user()->surname }}</span>
                            <span class="text-white fs-8 fw-bolder lh-1">Desenvolvedor</span>
                        </div>
                        <!--end::Name-->
                        <!--begin::Symbol-->
                        <div class="symbol symbol-30px symbol-md-40px">
                            <img src="/storage/profile/photo/{{ Auth::user()->profile_photo_path }}" alt="image">
                        </div>
                        <!--end::Symbol-->
                    </div>
                    <!--end::User info-->
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bolder d-flex align-items-center fs-5">{{ Auth::user()->surname }}
                                        <span class="badge badge-light-dark fw-bolder fs-8 px-2 py-1 ms-2">Caveiras</span></div>
